...
public class ServicioVigilanteTest {
	...
	public void realizarCobroUnaHoraCarroTest() {
		...
		Registro registro = registroTestDataBuilder.conFechaIngreso(Calendar.getInstance()).conFechaSalida(fechaSalida)
				.build();

		// act
		registro = vigilante.realizarCobro(registro, Parqueadero.getCostoCarrosHora(), Parqueadero.getCostoCarrosDia(),
				0);
		// assert
	...
	public void realizarCobroDiasHorasCarroTest() {
		...
		registro = vigilante.realizarCobro(registro, Parqueadero.getCostoCarrosHora(), Parqueadero.getCostoCarrosDia(),
				0);
		// assert
		assertEquals((Parqueadero.getCostoCarrosDia() * 8) + (Parqueadero.getCostoCarrosHora() * 3),
				registro.getCosto());
	...
	public void realizarCobroMotoAltoCilindrajeTest() {
		...
		// act
		registro = vigilante.realizarCobro(registro, Parqueadero.getCostoMotosHora(), Parqueadero.getCostoMotosDia(),
				Parqueadero.getExtraMotos());
		// assert
